...
<div class="heading">
   ...
   <p> <a href="home.php">Página principal</a> / Página de pesquisa </p>
</div>
...
<section class="products" style="padding-top: 0;">
   ...
   <form action="" method="post" class="box">
      ...
      <div class="price">Und<?php echo $fetch_product['price']; ?>.</div>
      <input type="number"  class="qty" name="product_quantity" min="1" value="1">
      <input type="hidden" name="product_name" value="<?php echo $fetch_product['name']; ?>">
      <input type="hidden" name="product_price" value="<?php echo $fetch_product['price']; ?>">
      <input type="hidden" name="product_image" value="<?php echo $fetch_product['image']; ?>">
      <input type="submit" class="btn" value="Próxima Leitura" name="add_to_cart">
   </form>
   <?php
            }
         }else{
         ...
         echo '<p class="empty">Procure algo!</p>';
      }
   ?>
   </div>
