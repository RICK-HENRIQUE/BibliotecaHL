...
<div class="heading">
   <h3>Contate-nos</h3>
   <p> <a href="home.php">Página Principal</a> / Contato </p>
</div>

<section class="contact">

   <form action="" method="post">
      <h3>Gostaria dizer algo!</h3>
      ...
      <input type="number" name="number" required placeholder="Coloque seu número" class="box">
