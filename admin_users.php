...
<section class="users">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <p> Nome de usuário : <span><?php echo $fetch_users['name']; ?></span> </p>
         ...
         <a href="admin_users.php?delete=<?php echo $fetch_users['id']; ?>" onclick="return confirm('Excluir este usuário?');" class="delete-btn">Deletar usuário</a>
      </div>
      <?php
         };
      ?>
