...
if(isset($_POST['update_order'])){
   ...
   $message[] = 'O status de recebido foi atualizado!';
...
<section class="orders">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <p> Quantidade Total : <span>Und<?php echo $fetch_orders['total_price']; ?>.</span> </p>
         ...
         <form action="" method="post">
            ...
            <a href="admin_orders.php?delete=<?php echo $fetch_orders['id']; ?>" onclick="return confirm('Excluir este pedido?');" class="delete-btn">Delete</a>
         </form>
      </div>
      <?php
         }
